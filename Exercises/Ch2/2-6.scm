;;; SICP Exercise 2.6 by Yuzhe Wu, 9 Dec 2017
...
;;; we can get by without numbers (at least insofar as nonnegative inte-
;;; gers are concerned) by implementing 0 and the operation of adding 1
;;; as
;;;
...
(newline)(display ((one 1+) 0))         ; -> 1
(newline)(display ((two 1+) 0))         ; -> 2
(newline)(display (((+ one two) 1+) 0)) ; -> 3